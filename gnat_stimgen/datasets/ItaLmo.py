...
pstimlist: list[PictureStimulus] = [
    ...
    PictureStimulus("pos19.jpg", "3 young friends from behind, on the sea rocks",    "pos"),
    #               Filename,    Description,                          Valence
    ...
    PictureStimulus("pos23.jpg", "Cow grazing in the meadow",         "pos"),
    ...
    PictureStimulus("pos40.jpg", "2 fish among the corals",       "pos"),
    # NEGATIVE PICTURE STIMULI
    #               Filename,    Description,                       Valence
    PictureStimulus("neg01.jpg", "Gutted hamster on a cloth",       "neg"),
